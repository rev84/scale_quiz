...
var Utl, answer, initAudio, onResize, play, refresh, startGame, startQuestion, startTimer, stopTimer;
...
onResize = function() {
  if (window.currentQuestion !== null) {
    return window.currentQuestion.fontSize = 0.8 * Utl.getFillFontSize($('#question_body'), window.currentQuestion.question);
  }
};

initAudio = function() {
  var body, index, name, ref, results;
  ...
  for (name in ref) {
    ...
    results.push((function() {
      ...
      for (index = j = 0; j < 5; index = ++j) {
        results1.push(window.audios[name].push(new Audio(body)));
      }
      return results1;
    })());
  }
